...
write("pages/components/button.html", component_page(
    ...
    anatomy_html=anatomy(
        '<svg width="380" height="160" viewBox="0 0 380 160"><rect x="80" y="60" width="220" height="48" fill="#32FA96"/><text x="100" y="92" font-family="IBM Plex Mono" font-size="14" font-weight="500" fill="#3C433C">label</text><text x="275" y="92" font-family="IBM Plex Mono" font-size="14" fill="#3C433C">→</text><circle cx="50" cy="84" r="9" fill="#FFF" stroke="#91938C"/><text x="46" y="88" font-family="IBM Plex Mono" font-size="11" font-weight="600">1</text><circle cx="190" cy="40" r="9" fill="#FFF" stroke="#91938C"/><text x="186" y="44" font-family="IBM Plex Mono" font-size="11" font-weight="600">2</text><circle cx="295" cy="125" r="9" fill="#FFF" stroke="#91938C"/><text x="291" y="129" font-family="IBM Plex Mono" font-size="11" font-weight="600">3</text></svg>',
...
write("pages/components/breadcrumb.html", component_page(
    ...
    anatomy_html=anatomy(
        '<svg width="500" height="60" viewBox="0 0 500 60"><text x="40" y="36" font-family="IBM Plex Mono" font-size="12" fill="#91938C" letter-spacing="1">HOME</text><text x="100" y="36" font-family="IBM Plex Mono" font-size="14" fill="#32FA96">/</text><text x="120" y="36" font-family="IBM Plex Mono" font-size="12" fill="#91938C" letter-spacing="1">COMPONENTS</text><text x="225" y="36" font-family="IBM Plex Mono" font-size="14" fill="#32FA96">/</text><text x="245" y="36" font-family="IBM Plex Mono" font-size="12" fill="#3C433C" font-weight="500" letter-spacing="1">BREADCRUMB</text><circle cx="105" cy="32" r="9" fill="#FFF" stroke="#91938C"/><text x="101" y="36" font-family="IBM Plex Mono" font-size="11" font-weight="600">1</text><circle cx="270" cy="20" r="9" fill="#FFF" stroke="#91938C"/><text x="266" y="24" font-family="IBM Plex Mono" font-size="11" font-weight="600">2</text></svg>',
...
write("pages/components/form.html", component_page(
    ...
    states='<div class="stack">' + demo('<div class="form-group"><label class="form-label" for="ss">default</label><input class="input" id="ss"></div>') + demo('<div class="form-group"><label class="form-label" for="sd">disabled</label><input class="input" id="sd" value="readonly" disabled></div>') + demo('<div class="form-group"><label class="form-label" for="se">erro</label><input class="input invalid" id="se" value="email@inv"><div class="form-error">formato de email inválido</div></div>') + '</div>',
    modifiers=api_table([
