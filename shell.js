...
(function () {
  ...
  const navConfig = [
    ...
    { id: 'components', section: 'components', items: [
      ...
      { id: 'file-uploader',label: 'file uploader',       href: 'pages/components/file-uploader.html' },
      { id: 'form',         label: 'form',                href: 'pages/components/form.html' },
      { id: 'inline-notif', label: 'inline notification', href: 'pages/components/inline-notification.html' },
      ...
      { id: 'toggle',       label: 'toggle (switch)',     href: 'pages/components/toggle.html' },
